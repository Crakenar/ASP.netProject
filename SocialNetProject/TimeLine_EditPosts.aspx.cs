...
{
    public partial class TimeLine_EditPosts : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter SDA2 = new SqlDataAdapter();
            SDA2.InsertCommand = new SqlCommand();

            SDA.InsertCommand.CommandType = CommandType.Text;
            SDA.InsertCommand.Connection = SC;

            SDA2.InsertCommand.CommandType = CommandType.Text;
            SDA2.InsertCommand.Connection = SC;
            SDA.InsertCommand.CommandText = "insert into tbl_posts values (@p1,@p2,@p3,@p4,@p5,@p6)";
            SDA2.InsertCommand.CommandText = "insert into tbl_activity values (@p7,@p8,@p9)";
            ...
            SDA.InsertCommand.Parameters.AddWithValue("@p4", TextBox1.Text);
            SDA.InsertCommand.Parameters.AddWithValue("@p5", 0);
            SDA.InsertCommand.Parameters.AddWithValue("@p6", 0);

            SDA2.InsertCommand.Parameters.AddWithValue("@p7", ID);
            SDA2.InsertCommand.Parameters.AddWithValue("@p8", DateTime.Now.Ticks);
            SDA2.InsertCommand.Parameters.AddWithValue("@p9", "new post");
